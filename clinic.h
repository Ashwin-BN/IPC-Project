...
void addAppointment(struct Appointment* appointment, int maxAppointment, struct Patient* patient, int maxPatients);


// Remove an appointment record from the appointment array
void removeAppointment(struct Appointment* appointment, int maxAppointment, struct Patient* patient, int maxPatients);
...
int findIndexByDate(int patientID, struct Date inputDate, const struct Appointment appointment[], int);
